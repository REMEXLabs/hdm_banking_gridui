...
function overwriteDefaultWithGpiiSettings() {
    ...
    scanCyclesDropdown.overwriteDefault();
    scanSpeedDropdown.overwriteDefault();
    scanColorDropdown.overwriteDefault();
    scanModeCheckbox.overwriteDefault();
...
var scanCyclesDropdown;
var scanSpeedDropdown;
var scanColorDropdown;
    ...
    GPIIconnector.getPreferenceSet(null, function(){
        ...
        for (var component in UIComponentList) {
            ...
            switch(UIComponentList[component].category) {
                ...
                case "cat6":
                    html_cat6 += createComponent(UIComponentList[component]);
                    break;
        ...
        $("#category-6-dynamic-components .componentlist").html(html_cat6);
        ...
        scanCyclesDropdown = new AS_DropDown();
        scanCyclesDropdown.init("scanCycles_dropdown");

        scanSpeedDropdown = new AS_DropDown();
        scanSpeedDropdown.init("scanSpeed_dropdown");

        scanColorDropdown = new AS_DropDown();
        scanColorDropdown.init("scanColor_dropdown");

        scanModeCheckbox = new AS_CheckBox();
        scanModeCheckbox.init("scanMode_checkbox");
        ...
        function resetAll() {
            console.log("Reset all");
             ...
             scanCyclesDropdown.reset();
             scanSpeedDropdown.reset();
             scanColorDropdown.reset();
             scanModeCheckbox.reset();
        }
